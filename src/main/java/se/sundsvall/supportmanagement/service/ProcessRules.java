...
public final class ProcessRules {
	 ...
	 * @return               whether a start is possible, and the keys it may name.
	 */
	public static ProcessStartOptions startableOf(final boolean runsProcesses, final List<ErrandProcessEntity> instances, final Supplier<ProcessKeySelection> labels,
		final BooleanSupplier startOnItsWay) {

		final var options = startOptionsOf(runsProcesses, instances, labels);
