...
public class SubscriptionService {
	...
	public List<Subscription> findSubscriptions(final String municipalityId, final String namespace, final String subscriberId) {
		loadSubscriberOrThrow(municipalityId, namespace, subscriberId);
	...
	public String createSubscription(final String municipalityId, final String namespace, final String subscriberId, final Subscription subscription) {
		final var subscriber = loadSubscriberOrThrow(municipalityId, namespace, subscriberId);
	...
	private SubscriberEntity loadSubscriberOrThrow(final String municipalityId, final String namespace, final String subscriberId) {
