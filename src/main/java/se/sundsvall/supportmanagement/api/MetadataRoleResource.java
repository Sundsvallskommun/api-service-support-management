...
class MetadataRoleResource {
	...
	MetadataRoleResource(final MetadataService metadataService, final AccessControlService accessControlService) {
		this.metadataService = metadataService;
		this.accessControlService = accessControlService;
	}

	@PostMapping(consumes = APPLICATION_JSON_VALUE, produces = ALL_VALUE)
	@Operation(summary = "Create role", description = "Create new role for the namespace and municipality", responses = {
	...
	ResponseEntity<Void> createRole(
		...
		accessControlService.verifyNamespaceAuthorization(namespace, municipalityId, ProtectedResource.METADATA_ROLE, RW);
	...
	@Operation(summary = "Get roles", description = "Get all roles for the namespace and municipality", responses = {
		@ApiResponse(responseCode = "200", description = "Successful operation", useReturnTypeSchema = true),
		@ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(mediaType = APPLICATION_PROBLEM_JSON_VALUE, schema = @Schema(oneOf = {
			Problem.class, ConstraintViolationProblem.class
		}))),
	...
	ResponseEntity<Role> updateRole(
		...
		@Parameter(name = "municipalityId", description = "Municipality id", example = "2281") @ValidMunicipalityId @PathVariable final String municipalityId,
		@Parameter(name = "id", description = "Role id", example = "5f79a808-0ef3-4985-99b9-b12f23e202a7") @ValidUuid @PathVariable final String id,
		@Validated(OnUpdate.class) @NotNull @RequestBody final Role body) {
