...
class RevisionResource {
	...
	ResponseEntity<List<Revision>> getErrandRevisions(
		...
		return ok(revisionService.getErrandRevisions(namespace, municipalityId, id));
	}
	...
	ResponseEntity<DifferenceResponse> getErrandDiffByVersions(
		...
		return ok(revisionService.compareErrandRevisionVersions(namespace, municipalityId, id, source, target));
	}
	...
	ResponseEntity<List<Revision>> getErrandNoteRevisions(
		...
		return ok(revisionService.getNoteRevisions(namespace, municipalityId, id, noteId));
	}
	...
	ResponseEntity<DifferenceResponse> getErrandNoteDiffByVersions(
		...
		return ok(revisionService.compareNoteRevisionVersions(namespace, municipalityId, id, noteId, source, target));
	}
