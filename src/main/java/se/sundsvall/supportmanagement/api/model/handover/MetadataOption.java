...
/**
 * A minimal projection of a namespace-bound metadata entry (e.g. a status), carrying only the technical name and
 * display name needed to render a handover mapping GUI.
 */
