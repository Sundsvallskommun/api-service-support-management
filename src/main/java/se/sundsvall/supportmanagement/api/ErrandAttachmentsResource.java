...
class ErrandAttachmentsResource {
	...
	ResponseEntity<ErrandAttachment> updateErrandAttachment(
		@Parameter(name = "namespace", description = "Namespace", example = "MY_NAMESPACE") @Pattern(regexp = NAMESPACE_REGEXP, message = NAMESPACE_VALIDATION_MESSAGE) @PathVariable final String namespace,
		@Parameter(name = "municipalityId", description = "Municipality id", example = "2281") @ValidMunicipalityId @PathVariable final String municipalityId,
		@Parameter(name = "errandId", description = "Errand id", example = "b82bd8ac-1507-4d9a-958d-369261eecc15") @ValidUuid @PathVariable("errandId") final String errandId,
		@Parameter(name = "attachmentId", description = "Errand attachment id", example = "5f79a808-0ef3-4985-99b9-b12f23e202a7") @ValidUuid @PathVariable("attachmentId") final String attachmentId,
		@Valid @NotNull @RequestBody final UpdateErrandAttachmentRequest request) {

		return ok(errandAttachmentService.updateErrandAttachment(namespace, municipalityId, errandId, attachmentId, request));
	}
	...
	@Operation(summary = "Delete errand attachment", description = "Deletes the errand attachment that matches the provided errand id and attachment id", responses = {
		...
		@ApiResponse(responseCode = "409",
			description = "Conflict - the attachment belongs to a decision that can no longer be changed",
	...
	@DeleteMapping(path = "/{attachmentId}/purpose")
	@Operation(summary = "Clear errand attachment purpose", description = "Clears what the attachment is for. The attachment purpose itself stays in the metadata of the namespace", responses = {
		@ApiResponse(responseCode = "204", description = "Successful operation", useReturnTypeSchema = true),
		@ApiResponse(responseCode = "400", description = "Bad request", content = @Content(mediaType = APPLICATION_PROBLEM_JSON_VALUE, schema = @Schema(oneOf = {
			Problem.class, ConstraintViolationProblem.class
		}))),
	...
	ResponseEntity<Void> deleteErrandAttachmentPurpose(
		@Parameter(name = "namespace", description = "Namespace", example = "MY_NAMESPACE") @Pattern(regexp = NAMESPACE_REGEXP, message = NAMESPACE_VALIDATION_MESSAGE) @PathVariable final String namespace,
		@Parameter(name = "municipalityId", description = "Municipality id", example = "2281") @ValidMunicipalityId @PathVariable final String municipalityId,
		@Parameter(name = "errandId", description = "Errand id", example = "b82bd8ac-1507-4d9a-958d-369261eecc15") @ValidUuid @PathVariable("errandId") final String errandId,
		@Parameter(name = "attachmentId", description = "Errand attachment id", example = "5f79a808-0ef3-4985-99b9-b12f23e202a7") @ValidUuid @PathVariable("attachmentId") final String attachmentId) {

		errandAttachmentService.deleteErrandAttachmentPurpose(namespace, municipalityId, errandId, attachmentId);
		return noContent()
			.header(CONTENT_TYPE, ALL_VALUE)
			.build();
	}
