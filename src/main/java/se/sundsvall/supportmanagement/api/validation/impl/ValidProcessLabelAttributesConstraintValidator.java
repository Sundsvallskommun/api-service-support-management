...
/**
 * Validates the process attributes of every label in a tree against three rules, and reports each fault as a violation
...
public class ValidProcessLabelAttributesConstraintValidator implements ConstraintValidator<ValidProcessLabelAttributes, Collection<Label>> {
	...
	private static String excerptOf(final String value) {
		return StringUtils.abbreviate(value, VALUE_EXCERPT_LENGTH);
	}
}
