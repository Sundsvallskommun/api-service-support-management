...
@Transactional
@CircuitBreaker(name = "decisionOutcomeRepository")
public interface DecisionOutcomeRepository extends JpaRepository<DecisionOutcomeEntity, String> {

	List<DecisionOutcomeEntity> findAllByNamespaceAndMunicipalityId(String namespace, String municipalityId, Sort sort);
	...
	DecisionOutcomeEntity getByIdAndNamespaceAndMunicipalityId(String id, String namespace, String municipalityId);
