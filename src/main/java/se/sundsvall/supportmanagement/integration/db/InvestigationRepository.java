...
public interface InvestigationRepository extends JpaRepository<InvestigationEntity, String> {
	...
	Optional<InvestigationEntity> findByNamespaceAndMunicipalityIdAndErrandEntityIdAndId(String namespace, String municipalityId, String errandId, String id);

	List<InvestigationEntity> findByNamespaceAndMunicipalityIdAndErrandEntityIdOrderByCreated(String namespace, String municipalityId, String errandId);
}
