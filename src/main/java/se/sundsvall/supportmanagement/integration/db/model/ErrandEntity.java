...
public class ErrandEntity {
	...
	public List<ErrandPhaseEntity> getPhases() {
		return phases;
	}

	public void setPhases(final List<ErrandPhaseEntity> phases) {
		this.phases = phases;
	}

	public ErrandEntity withPhases(final List<ErrandPhaseEntity> phases) {
		this.phases = phases;
		return this;
	}
