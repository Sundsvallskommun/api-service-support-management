 ...
 */
@CircuitBreaker(name = "statementAttachmentRepository")
public interface StatementAttachmentRepository extends JpaRepository<StatementAttachmentEntity, String> {
}
