...
/**
 * Saves the attachment links of an artefact.
 * <p>
 ...
 */
@CircuitBreaker(name = "investigationAttachmentRepository")
public interface InvestigationAttachmentRepository extends JpaRepository<InvestigationAttachmentEntity, String> {
}
