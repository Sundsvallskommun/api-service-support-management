...
import generated.se.sundsvall.messageexchange.PageMessage;
...
public interface MessageExchangeClient {
	 ...
	 * @return
	 */
	@PostMapping(path = "/{municipalityId}/{namespace}/conversations/{conversationId}/messages", consumes = MULTIPART_FORM_DATA_VALUE)
	...
	ResponseEntity<PageMessage> getMessages(
		@PathVariable("municipalityId") String municipalityId,
		@PathVariable("namespace") String namespace,
		@PathVariable("conversationId") String conversationId,
		@QueryMap Pageable pageable);
