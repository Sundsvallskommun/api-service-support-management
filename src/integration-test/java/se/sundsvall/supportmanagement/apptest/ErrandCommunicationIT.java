...
class ErrandCommunicationIT extends AbstractAppTest {
	...
	void test01_sendEmail() throws Exception {
		setupCall()
			.withServicePath("/errands/ec677eb3-604c-4935-bff7-f8f0b500c8f4/communication/email")
			.withHttpMethod(POST)
	...
	void test02_sendEmailWithAttachments() throws Exception {
		setupCall()
			.withServicePath("/errands/cc236cf1-c00f-4479-8341-ecf5dd90b5b9/communication/email")
			.withHttpMethod(POST)
			.withRequest(REQUEST_FILE)
			.withExpectedResponseStatus(NO_CONTENT)
			.withExpectedResponseBodyIsNull()
	...
	void test03_sendSms() throws Exception {
		setupCall()
			.withServicePath("/errands/1be673c0-6ba3-4fb0-af4a-43acf23389f6/communication/sms")
			.withHttpMethod(POST)
			.withRequest(REQUEST_FILE)
			.withExpectedResponseStatus(NO_CONTENT)
			.withExpectedResponseBodyIsNull()
