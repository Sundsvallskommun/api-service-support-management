...
class MetadataStatusResourceFailureTest {
	...
	private static Stream<Arguments> createStatusArguments() {
		return Stream.of(
			Arguments.of("MY_NAMESPACE", "666", tuple("createStatus.municipalityId", "not a valid municipality ID")),
	...
	private static Stream<Arguments> getStatusArguments() {
		return Stream.of(
			Arguments.of("MY_NAMESPACE", "666", tuple("getStatus.municipalityId", "not a valid municipality ID")),
	...
	private static Stream<Arguments> getStatusesArguments() {
		return Stream.of(
			Arguments.of("MY_NAMESPACE", "666", tuple("getStatuses.municipalityId", "not a valid municipality ID")),
	...
	private static Stream<Arguments> deleteArguments() {
		return Stream.of(
			Arguments.of("MY_NAMESPACE", "666", tuple("deleteStatus.municipalityId", "not a valid municipality ID")),
