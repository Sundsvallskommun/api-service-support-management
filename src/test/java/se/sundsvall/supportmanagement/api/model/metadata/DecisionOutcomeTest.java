...
class DecisionOutcomeTest {
	...
	@Test
	void bean() {
		MatcherAssert.assertThat(DecisionOutcome.class, allOf(
	...
	void builder() {
		...
		// Act
		final var result = DecisionOutcome.create()
			.withId(id)
			.withName(name)
	...
	void noDirtOnCreatedBean() {
		assertThat(DecisionOutcome.create()).hasAllNullFieldsOrProperties();
		assertThat(new DecisionOutcome()).hasAllNullFieldsOrProperties();
	}
}
