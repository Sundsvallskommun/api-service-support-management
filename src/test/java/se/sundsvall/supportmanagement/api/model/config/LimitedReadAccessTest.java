...
class LimitedReadAccessTest {

	@Test
	void testBean() {
		assertThat(LimitedReadAccess.class, allOf(
	...
	void testCreatePattern() {
		final var resources = List.of(COMMUNICATION);
		final var fields = List.of(FieldAccess.create().withField(TITLE));

		final var bean = LimitedReadAccess.create()
	...
	void testNoDirtOnCreatedBean() {
		assertThat(LimitedReadAccess.create()).hasAllNullFieldsOrProperties();
		assertThat(new LimitedReadAccess()).hasAllNullFieldsOrProperties();
	}
}
