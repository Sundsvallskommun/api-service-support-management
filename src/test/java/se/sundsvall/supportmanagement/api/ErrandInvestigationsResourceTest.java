...
class ErrandInvestigationsResourceTest {
	...
	void createInvestigationAttachment() {
		...
		// Arrange
		when(serviceMock.createInvestigationAttachment(eq(NAMESPACE), eq(MUNICIPALITY_ID), eq(ERRAND_ID), eq(INVESTIGATION_ID), any(MultipartFile.class)))
	...
	void linkInvestigationAttachment() {
		...
		// Arrange
		when(serviceMock.linkInvestigationAttachment(NAMESPACE, MUNICIPALITY_ID, ERRAND_ID, INVESTIGATION_ID, ATTACHMENT_ID))
		...
		verify(serviceMock).linkInvestigationAttachment(NAMESPACE, MUNICIPALITY_ID, ERRAND_ID, INVESTIGATION_ID, ATTACHMENT_ID);
	}
