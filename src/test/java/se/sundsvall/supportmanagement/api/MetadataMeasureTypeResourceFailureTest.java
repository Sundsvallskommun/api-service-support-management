...
class MetadataMeasureTypeResourceFailureTest {
	...
	private static Stream<Arguments> createMeasureTypeArguments() {
		return Stream.of(
			Arguments.of("MY_NAMESPACE", "666", tuple("createMeasureType.municipalityId", "not a valid municipality ID")),
			Arguments.of("invalid,namespace", "2281", tuple("createMeasureType.namespace", "can only contain A-Z, a-z, 0-9, - and _")));
	}

	@ParameterizedTest
	@MethodSource("getMeasureTypeArguments")
	void getMeasureTypeWithInvalidArguments(final String namespace, final String municipalityId, final Tuple expectedResponse) {
	...
	private static Stream<Arguments> getMeasureTypeArguments() {
		return Stream.of(
			Arguments.of("MY_NAMESPACE", "666", tuple("getMeasureType.municipalityId", "not a valid municipality ID")),
			Arguments.of("invalid,namespace", "2281", tuple("getMeasureType.namespace", "can only contain A-Z, a-z, 0-9, - and _")));
	}

	@ParameterizedTest
	@MethodSource("getMeasureTypesArguments")
	void getMeasureTypesWithInvalidArguments(final String namespace, final String municipalityId, final Tuple expectedResponse) {
	...
	private static Stream<Arguments> getMeasureTypesArguments() {
		return Stream.of(
			Arguments.of("MY_NAMESPACE", "666", tuple("getMeasureTypes.municipalityId", "not a valid municipality ID")),
			Arguments.of("invalid,namespace", "2281", tuple("getMeasureTypes.namespace", "can only contain A-Z, a-z, 0-9, - and _")));
	}
	...
	private static Stream<Arguments> deleteArguments() {
		return Stream.of(
			Arguments.of("MY_NAMESPACE", "666", tuple("deleteMeasureType.municipalityId", "not a valid municipality ID")),
			Arguments.of("invalid,namespace", "2281", tuple("deleteMeasureType.namespace", "can only contain A-Z, a-z, 0-9, - and _")));
	}
}
