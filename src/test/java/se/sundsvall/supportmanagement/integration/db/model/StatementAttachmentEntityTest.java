...
class StatementAttachmentEntityTest {
	...
	private static final String[] RELATIONS = {
		"statementEntity", "attachmentEntity"
	};
	...
	@Test
	void hasValidBean() {
		MatcherAssert.assertThat(StatementAttachmentEntity.class, allOf(
	...
	void hasValidBuilderMethods() {
		...
		// Act
		final var result = StatementAttachmentEntity.create()
			.withId(id)
	...
	void onCreateSetsCreated() {
		final var entity = new StatementAttachmentEntity();
		entity.onCreate();
	...
	void noDirtOnCreatedBean() {
		assertThat(StatementAttachmentEntity.create()).hasAllNullFieldsOrProperties();
		assertThat(new StatementAttachmentEntity()).hasAllNullFieldsOrProperties();
	}
}
