...
class WebMessageCollectRepositoryTest {
	...
	void findAllByNamespaceAndMunicipalityId() {
		var result = repository.findAllByNamespaceAndMunicipalityId("namespace-1", "2281");

		assertThat(result).hasSize(2);
		assertThat(result.getFirst().getMunicipalityId()).isEqualTo("2281");
		...
		assertThat(result.getLast().getMunicipalityId()).isEqualTo("2281");
