...
class DecisionOutcomeEntityTest {
	...
	@Test
	void hasValidBean() {
		MatcherAssert.assertThat(DecisionOutcomeEntity.class, allOf(
	...
	void hasValidBuilderMethods() {
		...
		// Act
		final var result = DecisionOutcomeEntity.create()
			.withId(id)
			.withName(name)
	...
	void noDirtOnCreatedBean() {
		assertThat(DecisionOutcomeEntity.create()).hasAllNullFieldsOrPropertiesExcept(DEPRECATED);
		assertThat(new DecisionOutcomeEntity()).hasAllNullFieldsOrPropertiesExcept(DEPRECATED);
	}
}
