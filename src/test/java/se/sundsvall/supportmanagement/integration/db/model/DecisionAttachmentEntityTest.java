...
class DecisionAttachmentEntityTest {
	...
	private static final String[] RELATIONS = {
		"decisionEntity", "attachmentEntity"
	};
	...
	@Test
	void hasValidBean() {
		MatcherAssert.assertThat(DecisionAttachmentEntity.class, allOf(
	...
	void hasValidBuilderMethods() {
		...
		// Act
		final var result = DecisionAttachmentEntity.create()
			.withId(id)
	...
	void onCreateSetsCreated() {
		final var entity = new DecisionAttachmentEntity();
		entity.onCreate();
	...
	void noDirtOnCreatedBean() {
		assertThat(DecisionAttachmentEntity.create()).hasAllNullFieldsOrProperties();
		assertThat(new DecisionAttachmentEntity()).hasAllNullFieldsOrProperties();
	}
}
