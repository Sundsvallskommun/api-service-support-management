...
class ActionConfigConditionEntityTest {

	@Test
	void testBean() {
		MatcherAssert.assertThat(ActionConfigConditionEntity.class, allOf(
	...
	void hasValidBuilderMethods() {
		...
		final var entity = ActionConfigConditionEntity.create()
			.withId(id)
			.withKey(key)
			.withValues(values)
	...
	void hasNoDirtOnCreatedBean() {
		assertThat(ActionConfigConditionEntity.create()).hasAllNullFieldsOrProperties();
		assertThat(new ActionConfigConditionEntity()).hasAllNullFieldsOrProperties();
	}
}
