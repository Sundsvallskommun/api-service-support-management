...
class PwAlktConfigurationTest {
	...
	@Mock
	private PwAlktProperties propertiesMock;

	@Test
	void testFeignBuilderCustomizer() {
		final var configuration = new PwAlktConfiguration();
		...
		try (final MockedStatic<FeignMultiCustomizer> feignMultiCustomizerMock = Mockito.mockStatic(FeignMultiCustomizer.class)) {
			...
			assertThat(errorDecoderCaptor.getValue())
				...
				.hasFieldOrPropertyWithValue("bypassResponseCodes", List.of(422));
