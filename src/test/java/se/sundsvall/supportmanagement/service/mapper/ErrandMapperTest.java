...
class ErrandMapperTest {
	...
	void testToErrand() {
		...
		assertThat(errand).hasNoNullFieldsOrPropertiesExcept("notifications", "phases");
	}
	...
	void testToErrands() {
		...
		assertThat(errands).hasSize(1)
			...
			.containsExactly(tuple(
				...
				List.of(Parameter.create().withKey(PARAMETER_NAME).withValues(List.of(PARAMETER_VALUE))),
				ID,
				MODIFIED,
		...
		assertThat(errands.getFirst()).hasNoNullFieldsOrPropertiesExcept("notifications", "phases");
	}
