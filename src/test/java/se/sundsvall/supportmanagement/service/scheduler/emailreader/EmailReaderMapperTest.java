...
class EmailReaderMapperTest {
	...
	void toCommunicationEntity() {
		...
		// Assert
		assertThat(result).isNotNull().hasNoNullFieldsOrPropertiesExcept("id", "errandNumber", "errandAttachments", "senderId");
	...
	void toCommunicationEntityWhenRecipientsIsNull() {
		...
		// Assert
		assertThat(result).isNotNull().hasNoNullFieldsOrPropertiesExcept("id", "target", "errandNumber", "errandAttachments", "senderId");
