...
INSERT INTO metadata_label (created, modified, municipality_id, namespace, classification, display_name, id, parent_id, resource_name, resource_path, deprecated) VALUES
    ...
    ('2025-11-05 09:45:49.831000', NULL, '2262', 'CONTACTCENTER', 'CLASS', 'ROOT-DISPLAY-NAME', 'dd11aa01-0000-0000-0000-000000000005', null, 'ROOT', 'ROOT', false),
    ('2025-11-05 09:45:49.831000', NULL, '2262', 'CONTACTCENTER', 'CLASS', 'LEVELONE_1-DISPLAY-NAME', 'dd11aa01-0000-0000-0000-000000000004', 'dd11aa01-0000-0000-0000-000000000005', 'LEVELONE_1', 'ROOT/LEVELONE_1', false),
    ('2025-11-05 09:45:49.831000', NULL, '2262', 'CONTACTCENTER', 'CLASS', 'LEVELTWO_1-DISPLAY-NAME', 'dd11aa01-0000-0000-0000-000000000001', 'dd11aa01-0000-0000-0000-000000000004', 'LEVELTWO_1', 'ROOT/LEVELONE_1/LEVELTWO_1', false),
    ('2025-11-05 09:45:49.831000', NULL, '2262', 'CONTACTCENTER', 'CLASS', 'LEVELTWO_2-DISPLAY-NAME', 'dd11aa01-0000-0000-0000-000000000002', 'dd11aa01-0000-0000-0000-000000000004', 'LEVELTWO_2', 'ROOT/LEVELONE_1/LEVELTWO_2', false),
    ('2025-11-05 09:45:49.831000', NULL, '2262', 'CONTACTCENTER', 'CLASS', 'LEVELONE_2-DISPLAY-NAME', 'dd11aa01-0000-0000-0000-000000000003', 'dd11aa01-0000-0000-0000-000000000005', 'LEVELONE_2', 'ROOT/LEVELONE_2', false),
    -- 2584 labels
...
VALUES ('2281', 'ec677eb3-604c-4935-bff7-f8f0b500c8f4', 'ASSIGNED_GROUP_ID-1', 'ASSIGNED_USER_ID-1',
       ...
       ('2506', '7c57b4c3-9ef6-472d-8f03-5c15e9458ad6', 'ASSIGNED_GROUP_ID-X', 'ASSIGNED_USER_ID-X',
        null, 'NAMESPACE-2506', 'LOW', 'REPORTER_USER_ID-X', 'STATUS-2506', 'E-service', 'TYPE-2506',
        '2024-01-01 12:00:00.000', null, null, null, "ESCALATION_EMAIL_1", 'AP-23020001', false, 'STATUS-2',
        'ESERVICE_INTERNAL', '2024-01-01 12:00:00.000'),
       ('2506', 'c9efe03d-deff-4828-a043-541fa78ffdeb', 'ASSIGNED_GROUP_ID-X', 'ASSIGNED_USER_ID-X',
        null, 'NAMESPACE-2506', 'LOW', 'REPORTER_USER_ID-X', 'STATUS-2506', 'E-service', 'TYPE-2506',
...
VALUES (0, 0, 'Test Testorsson', 'userId', '2023-01-01 12:00:00.000', 'cc236cf1-c00f-4479-8341-ecf5dd90b5b9',
        ...
        '<p>html message body 1</p>'),
       (1, 1, 'Test Testorsson', 'userId', '2023-01-02 12:00:00.000', '59328e70-4297-4bb5-ba69-cb17f2d15a17',
        'KC-23020001', 'case2',
...
INSERT INTO communication_attachment(attachment_data_id, id,
                                     communication_id, mime_type, file_name, namespace, municipality_id, file_size)
...
INSERT INTO email_worker_config (id, enabled, municipality_id, namespace, days_of_inactivity_before_reject,
                                 ...
                                 ignore_auto_reply, ignore_no_reply, created, modified)
...
VALUES (1, '2281', 'NAMESPACE-1', '2021-12-31 23:59:59.999', '2022-12-31 23:59:59.999'),
       ...
       (6, '2506', 'NAMESPACE-2507', '2024-06-12 15:24:00.001', null);
...
VALUES (1, 'DISPLAY_NAME', 'Namespace 1', 'STRING'),
       ...
       (6, 'DISPLAY_NAME', 'Namespace 2507', 'STRING'),
       (6, 'SHORT_CODE', 'FL', 'STRING'),
       (6, 'NOTIFICATION_TTL_IN_DAYS', '40', 'INTEGER'),
       (6, 'ACCESS_CONTROL', 'true', 'BOOLEAN'),
       (6, 'NOTIFY_REPORTER', 'false', 'BOOLEAN'),
       (6, 'ROLE_BASED_MAPPING', 'false', 'BOOLEAN'),
       (6, 'RESOURCE_ACCESS_CONTROL', 'true', 'BOOLEAN');
...
VALUES ('2281', 100, 'NAMESPACE-1', 'EXTERNAL', 'f4524497-a592-4618-a746-b59a60a76f13',
        'ec677eb3-604c-4935-bff7-f8f0b500c8f4', '4c0167ae-18b2-459a-a5b3-52511d5979f9', 'The topic 1'),
...
VALUES ('f4524497-a592-4618-a746-b59a60a76f13', 'RELATION-ID-1'),
       ...
       ('7a772d18-a588-41bc-91ec-13b7421c9bb9', 'RELATION-ID-3');
...
-- -----------------------------------
INSERT INTO measure(id, errand_id, responsible_user, measure_type_id, planned_start, planned_complete, executed, added_by_user, added_by_role, goal, description, accept, accept_motivation, rework_goal, rework_description, created, modified)
VALUES ('ee000000-0000-0000-0000-000000000100', 'ec677eb3-604c-4935-bff7-f8f0b500c8f4', 'joe01doe', 'dd000000-0000-0000-0000-000000000100', '2024-01-15 10:00:00.000', '2024-02-15 10:00:00.000', null, 'joe01doe', 'ROLE-1', 'Improve response time', 'Detailed description of measure 1', null, null, null, null, '2024-01-10 12:00:00.000', null),
       ('ee000000-0000-0000-0000-000000000101', 'ec677eb3-604c-4935-bff7-f8f0b500c8f4', 'jane11dane', 'dd000000-0000-0000-0000-000000000101', '2024-03-01 08:00:00.000', '2024-04-01 08:00:00.000', '2024-03-15 14:00:00.000', 'jane11dane', 'ROLE-2', 'Follow up on progress', 'Follow-up description', 'TRUE', 'Approved after review', null, null, '2024-01-10 12:00:00.000', '2024-03-16 09:00:00.000');
