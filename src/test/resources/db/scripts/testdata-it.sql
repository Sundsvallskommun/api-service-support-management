...
INSERT INTO namespace_config(id, municipality_id, namespace, created, modified)
VALUES (7, '2281', 'PROCESS-NAMESPACE', '2026-01-01 10:00:00.000', null);

INSERT INTO namespace_config_value(namespace_config_id, `key`, `value`, `type`)
VALUES (7, 'DISPLAY_NAME', 'Process namespace', 'STRING'),
       (7, 'SHORT_CODE', 'PN', 'STRING'),
       (7, 'NOTIFICATION_TTL_IN_DAYS', '10', 'INTEGER'),
       (7, 'ACCESS_CONTROL', 'false', 'BOOLEAN'),
       (7, 'NOTIFY_REPORTER', 'false', 'BOOLEAN'),
       (7, 'ROLE_BASED_MAPPING', 'false', 'BOOLEAN'),
       (7, 'RESOURCE_ACCESS_CONTROL', 'false', 'BOOLEAN'),
       (7, 'PROCESS_CONSUMER', 'pw-alkt', 'STRING');
