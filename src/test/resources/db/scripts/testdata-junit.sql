...
VALUES('3001', 'EXTERNAL_ID-1', 'EMPLOYEE', 'ERRAND_ID-1', 'ADDRESS-1', 'CARE_OF-1','COUNTRY-1','FIRST_NAME-1', 'LAST_NAME-1', 'ZIP_CODE-1');
INSERT INTO stakeholder(id, external_id, external_id_type, errand_id) VALUES('3002', 'EXTERNAL_ID-2', 'PRIVATE', 'ERRAND_ID-2');
INSERT INTO stakeholder(id, external_id, external_id_type, errand_id) VALUES('3003', 'EXTERNAL_ID-3', 'ENTERPRISE', 'ERRAND_ID-3');
INSERT INTO stakeholder(id, external_id, external_id_type, errand_id) VALUES('3004', 'EXTERNAL_ID-3', 'ENTERPRISE', 'ERRAND_ID-4');
