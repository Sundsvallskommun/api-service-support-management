...
Fem nya tabeller i tre migreringar: `V1_60__add_process_integration_tables.sql` med de tre första (byggs i
T1), `V1_61__add_errand_decision.sql` med beslutet (T9) och `V1_62__add_errand_process_signal.sql` med de
...
-- V1_61: arendets beslut. Ett per arende - unikheten AR invarianten (7.5). Arendedata, inte
...
-- V1_62: vad processen just nu vantar pa fran handlaggaren (5.9). Ersatts i sin helhet vid
